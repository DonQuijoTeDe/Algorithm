...
only one quantity of each item, In other words, given two integer arrays val[0..N-1]
...
capacity of the knapsack. In the next line are N space separated positive integers
denoting the values of the N items and in the fourth line are N space separated
positive integers denoting the weights of the corresponding items.
