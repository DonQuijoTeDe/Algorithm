...
Task
Write a program that, given the amount N to make change for and the number of
types M of infinitely available coins. Prints out how many different ways you
can make change from the coins to STDOUT.
