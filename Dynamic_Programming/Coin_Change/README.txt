...
infinite supply of each of S = { S1, S2, .. , Sm} valued coins. The order of coins
doesn’t matter. For example, for N = 4 and S = {1,2,3}, there are four solutions:
...
array. The second line contains M space-separated integers A1, A2, ..., AN denoting
